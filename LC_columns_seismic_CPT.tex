...
\begin{abstract} In this project, seismic (Cone Penetration Testing) CPT has been evaluated as a test method to determine the properties of KC columns. The reason for using seismic CPT is that there both seismic value is obtained in the form of P-wave (compression wave), S-wave (shear wave) and a peak pressure. The seismic determinations in the field can be compared with seismic values ​​measured in laboratories. Furthermore, there is a connection between probing resistance and strength in the stabilized column. The seismic measurements in the laboratory were based on resonance frequency measurements where the specimen was excited with a blow and the damped resonance frequency was measured in both axial and transverse directions. 
\end{abstract}
...
The background to the project is the need to adequately evaluate the quality of KC columns in terms of strength and homogeneity. The purpose is to better connect laboratory measurements and field measurements to obtain a better and safer optimization of binders and binder types. In this sub-project, the aim is to evaluate seismic CPT to evaluate the quality of KC column reinforced soil. The adjacent projects have been based on the use of bending elements (bender elements) and resonant frequency measurement in the laboratory big project 'Seismic testing of stabilized soil with bender elements in triaxial tests' (Lindh, 2016a).

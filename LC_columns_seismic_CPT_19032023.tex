...
\begin{abstract} In this \hl{research }project, \hl{the }measurements of \hl{the }ultrasonic P- and S-waves and seismic Cone Penetration Testing (CPT) \hl{were applied} to identify subsurface conditions and properties of clayey soil stabilized with \hl{lime/cement} columns in \hl{the }Stockholm Norvik Port, Sweden. \hl{Applied} geophysical methods \hl{enabled to identify} a connection between \hl{the }resistance of soil and strength in the stabilized columns. The records of \hl{the }seismic tests were obtained in the laboratory of Swedish Geotechnical Institute (SGI) through estimated\hl{ }P- and S-wave velocities using \hl{techniques} of resonance frequency measurement of the stabilized\hl{ }specimens. The CPT profiles were used to evaluate the quality of the \hl{lime/cement} columns of the reinforced soil by \hl{the }interpretation of signals. The relationship between the P and S waves demonstrated \hl{a} gain in strength during \hl{soil hardening}. \hl{The} quality of soil \hl{was evaluated by seismic measurements with aim }to achieve sufficient strength of foundations prior to \hl{the }construction of \hl{the }infrastructure objects \hl{and industrial works. Seismic} CPT is an effective method essential to evaluate the correct placement of the CPT inside the column. This work demonstrated the\hl{ }alternative seismic methods supporting \hl{the }up-hole technology of drilling techniques for practical purpose in civil\hl{ }engineering \hl{and geotechnical works}. 
\end{abstract}
...
\section{Funding}
The Port of Stockholm \hl{Management}, \hl{Nordic Construction Company} (NCC) and Geomind are acknowledged for \hl{the }assistance with data collection and support with\hl{ }survey. The Swedish Transport Administration, Skanska Group AB and the Development Fund of the Swedish Construction Industry (SBUF) provided financial contribution to this project. The authors express gratitude to \hl{the} Swedish Maritime Administration (SMA) \hl{and} Cemex AB for provided adhesives and \hl{technical }support of \hl{this research} project.
